...
class SettingPageFirebase extends StatefulWidget {
  //
  const SettingPageFirebase({super.key});
  @override
  State<SettingPageFirebase> createState() => _SettingPageFirebaseState();
}

class _SettingPageFirebaseState extends State<SettingPageFirebase> {
