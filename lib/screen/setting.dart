...
class _SettingPageState extends State<SettingPage> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildSwitchTile(Icons.location_on, "Lokasi Otomatis", "Jakarta, Indonesia",
                isAutoLocation, (v) => setState(() => isAutoLocation = v),
                cardColor, textColor),
            _buildNavTile(Icons.access_time, "Zona Waktu", "WIB (GMT+7)", cardColor, textColor),

            const SizedBox(height: 16),
            _buildSectionTitle("Notifikasi", textColor),
            _buildSwitchTile(Icons.notifications, "Notifikasi Push",
                "Pengingat kegiatan & sholat",
                isPushNotif, (v) => setState(() => isPushNotif = v),
                cardColor, textColor),

            const SizedBox(height: 16),
            _buildSectionTitle("Bahasa", textColor),
            _buildNavTile(Icons.language, "Bahasa Aplikasi", "Bahasa Indonesia",
                cardColor, textColor),

            const SizedBox(height: 16),
            _buildSectionTitle("Tentang", textColor),
            _buildInfoTile("Versi Aplikasi", "1.0.0", cardColor, textColor),
            _buildNavTile(Icons.article, "Syarat & Ketentuan", null, cardColor, textColor),
            _buildNavTile(Icons.privacy_tip, "Kebijakan Privasi", null, cardColor, textColor),
  ...
  Widget _buildSwitchTile(IconData icon, String title, String subtitle, bool value,
      Function(bool) onChanged, Color cardColor, Color textColor) {
    return Card(
      color: cardColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: ListTile(
  ...
  Widget _buildNavTile(
      IconData icon, String title, String? subtitle, Color cardColor, Color textColor) {
    return Card(
      color: cardColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: ListTile(
        ...
        title: Text(title, style: TextStyle(color: textColor)),
        subtitle:
            subtitle != null ? Text(subtitle, style: TextStyle(color: textColor.withOpacity(0.7))) : null,
  ...
  Widget _buildInfoTile(String title, String value, Color cardColor, Color textColor) {
    return Card(
      color: cardColor,
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
      child: ListTile(
